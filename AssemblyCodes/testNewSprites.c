...
int main(){
	...
	// while(1){ if(isFull() == 0) { set_sprite(sprt_1.data_register, sprt_1.coord_x, sprt_1.coord_y, sprt_1.offset, 0); break; } }
	...
	while(1){ if(isFull() == 0) {setPolygon(0b000000001, 0b0011, 0b11111111, 1, 0b0001, 50, 50); break; } }
